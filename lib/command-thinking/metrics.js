...
function getMetricsFilePath() {
  return getMetricsPath('commandThinking');
}
...
function loadMetrics() {
  try {
    ...
    console.warn(`Failed to load metrics from ${getMetricsFilePath()}:`, error.message);
    metrics = {};
  }
}
...
function saveMetrics() {
  try {
    ...
    console.warn(`Failed to save metrics to ${getMetricsFilePath()}:`, error.message);
  }
}
...
function getSummary() {
  ...
  return {
    ...
    metricsPath: getMetricsFilePath()
  };
}
