...
```bash
INIT=$(node ~/.claude/get-shit-done/bin/gsi-tools.js init new-project)
```
...
```bash
mkdir -p .planning
node ~/.claude/get-shit-done/bin/gsi-tools.js commit "docs: initialize project" --files .planning/PROJECT.md
```
...
```bash
node ~/.claude/get-shit-done/bin/gsi-tools.js commit "chore: add project config" --files .planning/config.json
```
...
```bash
node ~/.claude/get-shit-done/bin/gsi-tools.js commit "docs: define v1 requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
node ~/.claude/get-shit-done/bin/gsi-tools.js commit "docs: create roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
