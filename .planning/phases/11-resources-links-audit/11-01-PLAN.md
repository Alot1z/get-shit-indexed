...
must_haves:
  truths:
    ...
    - "All links pointing to original GSD repo updated to fork"
...
Purpose: Ensure all links work and reference the correct GSI fork, not original GSD
...
- Original (DO NOT LINK): https://github.com/gsd-build/get-shit-done
</context>
...
<task type="auto">
  ...
  <action>
    ...
    2. Identify links to original GSD repo
    3. Update to point to fork:
       - gsd-build/get-shit-done → Alot1z/get-shit-indexed
       - Update clone URLs
