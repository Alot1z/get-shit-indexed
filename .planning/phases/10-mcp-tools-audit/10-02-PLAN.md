...
must_haves:
  truths:
    ...
    - "Any GSD branding in tool outputs updated"
...
- CLI tools (gsd-tools.js / gsi-tools.js)
...
<task type="auto">
  ...
  <action>
    ...
    1. Locate gsi-tools.js (formerly gsd-tools.js)
    2. Document available commands
    3. Check for GSD references in output
...
<task type="auto">
  ...
  <action>
    ...
    2. Check for GSD references in hooks
