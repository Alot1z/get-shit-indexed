...
Find and replace all hardcoded absolute paths (like `@C:\Users\mose\.claude\rules\`) with relative package references that work on any system.
...
@C:\Users\mose\.claude\rules\tool-priority.md
```
